...
class homepage():
    ...
    def reference(self):
        ...
        back()
    def ushimata(self):
        list_stocks_area=driver.find_element_by_id('com.lanyi.live:id/list_stocks')
        list_stocks=list_stocks_area.find_elements_by_class_name('android.widget.LinearLayout')
        list_stocks[0].click()
        back()
        driver.find_element_by_id('com.lanyi.live:id/btn_more_stocks').click()
        back()
        print u'牛股收益榜查看成功'
    def textlive(self):
        ...
        print u'查看图文直播成功'
homepage().stockboard()
homepage().reviewvideo()
homepage().stockschoolpart()
homepage().reference
homepage().ushimata()
homepage().textlive()
